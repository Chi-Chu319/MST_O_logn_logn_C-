...
# Source files
SOURCES = main.cpp tester.cpp algo/algo_mpi.cpp algo/graph_local.cpp algo/graph.cpp algo/quick_union.cpp algo/prim.cpp algo/kruskal.cpp algo/utils/graph_util.cpp algo/utils/csv_util.cpp
